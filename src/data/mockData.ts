...
export const mockPackages: PackageKit[] = [
  {
    ...
    editions: [
      { id: 'kit-nomad-black', label: 'Black Edition', imageUrl: '/images/packages/nomad-black.png', packageNumber: 'MOCK-NOMAD-BLACK', pricing: { '48h': 2490, '72h': 2790 }, depositAmount: 400, description: 'A compact solo/duo setup in black.' },
      { id: 'kit-nomad-khaki', label: 'Khaki Edition', imageUrl: '/images/packages/nomad-khaki.png', packageNumber: 'MOCK-NOMAD-KHAKI', pricing: { '48h': 2490, '72h': 2790 }, depositAmount: 400, description: 'A compact solo/duo setup in khaki.' },
    ],
  ...
  },
  {
    ...
    editions: [
      { id: 'kit-basecamper-black', label: 'Black Edition', imageUrl: '/images/packages/base-camper-black.png', packageNumber: 'MOCK-BASECAMPER-BLACK', pricing: { '48h': 5690, '72h': 6210 }, depositAmount: 900, description: 'A full group setup in black.' },
